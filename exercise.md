...
plot 2*x*x*sqrt(x)-5*x*x title "f1(x)", x/log(x)  t "f2(x)"
...
plot "weather2025.csv" using 1:2 with lines title "最高気温", "weather2025.csv" using 1:3 with lines title "最高気温（平均）", "weather2025.csv" using 1:4 with lines title "最低気温", "weather2025.csv" using 1:5 with lines title "最低気温（平均）"
